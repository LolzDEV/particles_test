...
use sdl2::rect::Rect;
use crate::game::{Particle, World, Sand, ParticleType, Wood, Water};
    ...
    'running: loop {
            ...
            match event {
                ...
                Event::KeyDown { keycode: Some(k), .. } => {
                    match k {
                        ...
                        Keycode::Num3 => current_particle = ParticleType::WATER, // Set water as current brush
        ...
        if pressing { // If pressing the left mouse button
            match current_particle {
                ...
                ParticleType::WATER => { // Spawn the wood inside the brush area
                    for i in 0..5 {
                        world.spawn_particle(Box::new(Water {
                            x: mouse_position.0 + i - 2,
                            y: mouse_position.1 + 4,
                            does_exists: true
                        }));
